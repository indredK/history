...
export function SongFigureDetailModal({ figure, open, onClose }: SongFigureDetailModalProps) {
  ...
  const lifespan = songFigureService.formatLifespan(figure);
  const age = songFigureService.calculateAge(figure);
...
export default SongFigureDetailModal;
