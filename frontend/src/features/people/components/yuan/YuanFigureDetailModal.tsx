...
export function YuanFigureDetailModal({ figure, open, onClose }: YuanFigureDetailModalProps) {
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth aria-labelledby="yuan-figure-detail-title" slotProps={{ paper: { sx: { background: 'var(--color-bg-card)', borderRadius: 'var(--radius-lg)', maxHeight: '90vh' } } }}>
