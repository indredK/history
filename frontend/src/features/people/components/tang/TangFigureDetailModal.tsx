...
export function TangFigureDetailModal({ figure, open, onClose }: TangFigureDetailModalProps) {
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth aria-labelledby="tang-figure-detail-title" PaperProps={{ sx: { background: 'var(--color-bg-card)', borderRadius: 'var(--radius-lg)', maxHeight: '90vh' } }}>
