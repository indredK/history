...
export function MingFigureDetailModal({ figure, open, onClose }: MingFigureDetailModalProps) {
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth aria-labelledby="ming-figure-detail-title" slotProps={{ paper: { sx: { background: 'var(--color-bg-card)', borderRadius: 'var(--radius-lg)', maxHeight: '90vh' } } }}>
      <DialogTitle id="ming-figure-detail-title" sx={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', pb: 1 }}>
...
export default MingFigureDetailModal;
