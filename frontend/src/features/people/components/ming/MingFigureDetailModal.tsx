...
export function MingFigureDetailModal({ figure, open, onClose }: MingFigureDetailModalProps) {
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth aria-labelledby="ming-figure-detail-title" PaperProps={{ sx: { background: 'var(--color-bg-card)', borderRadius: 'var(--radius-lg)', maxHeight: '90vh' } }}>
