...
export const DYNASTIES: Dynasty[] = [
  ...
  },
  {
    ...
    subPeriods: [
      { name: '魏', nameEn: 'Cao Wei', startYear: 220, endYear: 265, color: '#B8860B', description: '曹丕建立的政权，定都洛阳' },
      { name: '蜀', nameEn: 'Shu Han', startYear: 221, endYear: 263, color: '#DAA520', description: '刘备建立的政权，定都成都' },
      { name: '吴', nameEn: 'Eastern Wu', startYear: 229, endYear: 280, color: '#FFD700', description: '孙权建立的政权，定都建业' }
    ]
  },
  {
    name: '西晋',
  ...
  },
  {
    ...
    subPeriods: [
      { name: '宋', nameEn: 'Liu Song', startYear: 420, endYear: 479, color: '#CD853F', description: '刘裕建立的南朝政权' },
      { name: '齐', nameEn: 'Southern Qi', startYear: 479, endYear: 502, color: '#A0522D', description: '萧道成建立的南朝政权' },
      { name: '梁', nameEn: 'Liang Dynasty', startYear: 502, endYear: 557, color: '#8B4513', description: '萧衍建立的南朝政权' },
      { name: '陈', nameEn: 'Chen Dynasty', startYear: 557, endYear: 589, color: '#654321', description: '陈霸先建立的南朝政权' }
    ]
  },
  {
    name: '隋朝',
  ...
  },
  {
    ...
    subPeriods: [
      { name: '后梁', nameEn: 'Later Liang', startYear: 907, endYear: 923, color: '#A0522D', description: '朱温建立的政权' },
      { name: '后唐', nameEn: 'Later Tang', startYear: 923, endYear: 937, color: '#8B4513', description: '李存勖建立的政权' },
      { name: '后晋', nameEn: 'Later Jin', startYear: 936, endYear: 947, color: '#D2691E', description: '石敬瑭建立的政权' },
      { name: '后汉', nameEn: 'Later Han', startYear: 947, endYear: 951, color: '#CD853F', description: '刘知远建立的政权' },
      { name: '后周', nameEn: 'Later Zhou', startYear: 951, endYear: 960, color: '#DEB887', description: '郭威建立的政权' }
    ]
  },
  {
    name: '北宋',
